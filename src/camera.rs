...
impl CameraSettings {
    pub fn new<T1: Into<f64>, T2: Into<f64>, T3: Into<f64>, T4: Into<f64>>(
        v_fov: T1,
        aspect_ratio: T2,
        apeture: T3,
        focus_dist: T4,
...
impl Camera {
    pub fn new<T1: Into<f64>, T2: Into<f64>>(
        look_from: Point3,
        look_at: Point3,
        v_up: Vec3,
        ...
        let lower_left_corner =
            look_from - horizontal / 2.0 - vertical / 2.0 - settings.focus_dist * w;
